  ...
  useEffect(() => {
    const load = async () => {
      try {
        ...
        console.log('Leaderboard component fetched:', results);
        setData(results);
      } catch (err) {
        ...
        <div className="card-body">
          <form className="row g-3 mb-3" onSubmit={(e) => e.preventDefault()}>
            <div className="col-md-6">
              <label htmlFor="search-leaderboard" className="form-label">Search</label>
              <input
            ...
            <div className="col-md-6 d-flex align-items-end gap-2">
              ...
              <button type="button" className="btn btn-outline-secondary" onClick={async () => {
                try {
                  const refreshed = await fetchJson('leaderboard/');
                  setData(refreshed);
                } catch (err) {
          ...
          <div className="modal-dialog">
            <div className="modal-content">
              ...
              <div className="modal-body">
                <p>View rankings in a responsive table with quick search.</p>
              </div>
